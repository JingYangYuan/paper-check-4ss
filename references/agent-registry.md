...
| # | Agent Name | 文件路径 | 职责 | 工具 |
|---|-----------|---------|------|------|
| 47 | `paper-check-editorial-screening-reviewer` | `agents/editorial-screening-reviewer.md` | 首筛、创新可见度、题摘关键词/引言和期刊适配 | Read, Grep |
| 48 | `paper-check-argument-integrity-reviewer` | `agents/argument-integrity-reviewer.md` | 问题—论点—证据—结构—结尾闭环与十六缺憾 | Read, Grep |
| 49 | `paper-check-ethics-conformance-reviewer` | `agents/ethics-conformance-reviewer.md` | 引文注释和技术规范；无来源只标待核验 | Read, Grep |
