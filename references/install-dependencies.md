...
echo ""
echo "=== check ==="
test -f SKILL.md && echo "check/SKILL.md OK"
test -f glossary.md && echo "check/glossary.md OK"
test -f patterns.md && echo "check/patterns.md OK"
test -f cheatsheet.md && echo "check/cheatsheet.md OK"
