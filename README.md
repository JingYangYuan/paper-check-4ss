<p align="center">
  <img src="docs/banner.svg" alt="paper-check-4ss" width="100%">
</p>

# Paper 论文审稿检查 4SS

中文社会科学论文全流程审稿检查模块。用于全文审稿、投稿前自检、编辑视角评审、拒稿风险诊断和投稿命中率改进；诊断题目、摘要、结构、论证、诚信、技术规范与期刊适配，并将问题精确回流。
...
| **[paper-check-4ss](https://github.com/JingYangYuan/paper-check-4ss)**（本仓库） | 全文审稿、质量门控与精确回流 |
...
```bash
git clone https://github.com/JingYangYuan/paper-check-4ss.git
```
...
本包由总控 [`paper-master-4ss`](https://github.com/JingYangYuan/paper-master-4ss) 导出；对应源目录是总控包内的 `modules/check/`：
